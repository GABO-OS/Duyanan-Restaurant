            ...
            <div className="container-fluid px-4 px-lg-5">
                ...
                <div className={`${isNavCollapsed ? 'collapse' : ''} navbar-collapse`} id="navbarCollapse">
                    <ul className="navbar-nav ms-auto align-items-center">
                        ...
                        <li className="nav-item"><Link className={`nav-link ${location.pathname === '/event-packages' ? 'active' : ''}`} to="/event-packages" onClick={() => setIsNavCollapsed(true)} style={{ color: '#fff', fontWeight: 'bold', textShadow: '0 1px 2px rgba(0,0,0,0.3)' }}><i className="bi bi-gift me-3 d-lg-none"></i>Event Packages</Link></li>
                        <li className="nav-item"><Link className={`nav-link ${location.pathname === '/group-meals' ? 'active' : ''}`} to="/group-meals" onClick={() => setIsNavCollapsed(true)} style={{ color: '#fff', fontWeight: 'bold', textShadow: '0 1px 2px rgba(0,0,0,0.3)' }}><i className="bi bi-people me-3 d-lg-none"></i>Group Meals</Link></li>
